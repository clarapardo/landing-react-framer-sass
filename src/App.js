...
function App() {
  return (
    <motion.div initial='initial' animate='animate'>
      <motion.header variantes={stagger}>
        <motion.div className='logo_wrapper' variants={header}><span>clarapardo</span>dev</motion.div>
      ...
      <motion.div className='content_wrapper' initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.3, ease: easeing }}>
        ...
        <motion.div className='right_content_wrapper'>
          <motion.img src={process.env.PUBLIC_URL + '/images/bg.png'} alt="bg" initial={{ x: 200, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 0.8 }}></motion.img>
        </motion.div>
      </motion.div>
